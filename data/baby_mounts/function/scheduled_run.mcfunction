...
execute as @e[type=#eden:valid_baby_mount,tag=!eden.baby_mount.set,limit=10] at @s unless entity @e[tag=eden.baby_mount.set,distance=..8] if predicate eden:percentages/15percent run function baby_mounts:get_type
